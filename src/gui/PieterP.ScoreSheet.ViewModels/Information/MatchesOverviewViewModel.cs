...
namespace PieterP.ScoreSheet.ViewModels.Information {
    public class MatchesOverviewViewModel : ICanBeOrchestrated {
        public MatchesOverviewViewModel(ObservableCollection<CompetitiveMatchViewModel> activeMatches, ObservableCollection<AwayMatchInfo> awayMatches) {
            this.Rows = Cell.Create(1);
            this.Columns = Cell.Create(1);
            this.Matches = new ObservableCollection<OverviewMatchInfo>();
        ...
        private void Refresh() {
            ...
            foreach (var m in _activeMatches) {
                this.Matches.Add(new OverviewMatchInfo(m));
            }
        ...
        public ObservableCollection<OverviewMatchInfo> Matches { get; private set; }
    ...
    public class OverviewMatchInfo {
        public OverviewMatchInfo(AwayMatchInfo awayMatch) {
        ...
        public OverviewMatchInfo(CompetitiveMatchViewModel activeMatch) {
